          ...
          <div data-page="index" class="page">
            ...
            <div class="page-content">
              ...
              <div class="list-block">
                <ul>
                  <li>
                  <form role="form" method="post" action="../index/validasi_tanggal.php" enctype='multipart/form-data'>
                    <div class="item-content"> 
                        <div class="item-input">
                          <textarea type="text" placeholder="Klik Disini Untuk Pilih Tanggal" id="mCalenderID" name="date"></textarea>
                        </div>   
                    </div>
