  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
        ...
        <h3>Departement</h3>
        <div class="form-group">
          <label for="add1">Departement</label>
                        <select name="id_dept" class="form-control" required>
                              <option value='' selected>- Pilih Departement -</option>
                              
                              <?php
                                  $select=mysqli_query($mysqli,"SELECT * FROM departement");
                              while ($row1 = mysqli_fetch_array($select)){
                                echo "<option value=$row1[id_dept]>$row1[dept]</option>";
                              }
                              ?>
                        </select>
        </div>
        ...
        <div class="form-group">
          <label for="jeniskelaminpasangan">Level Keanggotaan Dalam Departement</label>
          <div class="radio">
            <label><input type="radio" name="status_anggota" <?php if (! empty($data) && $data['status_anggota']=="0") echo "checked";?> value="0">Anggota</label>
            <label><input type="radio" name="status_anggota" <?php if (! empty($data) && $data['status_anggota']=="1") echo "checked";?> value="1">Leader</label>
          </div>
        </div>
