...
$select = mysqli_query($mysqli,"SELECT * FROM partner_acc JOIN karyawan_jabatan ON partner_acc.ch_manager = karyawan_jabatan.id JOIN karyawan ON karyawan_jabatan.nik = karyawan.nik WHERE partner_acc.id=".$_GET['id']);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Detail Partner</li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    ...
    <div class="box-header">
      <h3 class="box-title">Detail <?=$data['partner_name']?></h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <div class="col-sm-12">
		  ...
		  <div class="row">
		  	...
		  	<div class="col-sm-12">
		  		<table class="table table-bordered">
					...
					<?php
						$query = mysqli_query($mysqli, "SELECT * FROM partner_contact WHERE status=1 AND partner_id = ".$_GET['id']." ORDER BY key_contact DESC");
