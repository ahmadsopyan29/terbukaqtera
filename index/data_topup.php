      ...
      <div class="box-header">
        <div class="row">
          ...
          <div class="col-sm-6" align="right">
              <a href='form_topup.php' class='btn btn-info' > Pengajuan Top Up Baru</a>
          </div>
        </div>
      </div>
    <!-- /.box-header -->
    ...
    <table id="example1" class="table table-bordered table-hover" role="grid" aria-describedby="tabelpegawai_info">
      <thead>
        <tr role="row">
          ...
          <th class="" tabindex="0" aria-controls="tabelpegawai" rowspan="1" colspan="1" aria-label="activate to sort column ascending">Reply from Admin</th>
