...
$select = mysqli_query($mysqli,"SELECT * FROM info_harga_view WHERE id=".$_GET['id']);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Informasi Harga
      <small>Detail Informasi Harga</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="">Project</li>
      <li class="active">Info Harga</li>
      <li class="active">Detail Informasi Harga</li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    ...
    <div class="box-header">
      <h3 class="box-title">Project <?=$data['company_name']?></h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <div class="col-sm-12">
					...
					<tr>
						...
						<td>
							<table class="table table-in table-bordered">
								...
								$no=1;
								$tot = 0;
								$products = mysqli_query($mysqli, "SELECT * FROM info_harga_products INNER JOIN product_ ON info_harga_products.product = product_.id WHERE info_harga_id= '".$_GET['id']."' AND opsi ='".$opsi."'");
